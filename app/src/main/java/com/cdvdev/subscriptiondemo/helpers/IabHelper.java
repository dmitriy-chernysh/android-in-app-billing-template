package com.cdvdev.subscriptiondemo.helpers;
...
import com.cdvdev.subscriptiondemo.BuildConfig;
import com.cdvdev.subscriptiondemo.utils.iab.IabException;
...
import com.cdvdev.subscriptiondemo.utils.iab.Security;
import com.cdvdev.subscriptiondemo.utils.iab.SkuDetails;
...
/**
 * Class for work with google In-app billing
 *
...
public class IabHelper {
    ...
    private static final String LOG_TAG = "IAB";
    ...
    public IabHelper(Context context, String base64LicenseKey) {
        mContext = context;
        mLicenseKey = base64LicenseKey;
    }

    /**
     * Callback when the setup process is complete.
     */
    public interface OnIabSetupFinishListener {
        ...
        mServiceConnection = new ServiceConnection() {
            ...
            public void onServiceConnected(ComponentName name, IBinder service) {
                ...
                try {
                    ...
                    if (finishListener != null) {
                        finishListener.onIabSetupFinished(
                                new IabResult(IABHELPER_REMOTE_EXCEPTION, "RemoteException while setting up in-app billing.")
                        );
                    }
                    e.printStackTrace();
                    return;
    ...
    /**
     *  Check that subscriptions are supported.
     */
    ...
    int queryPurchases(Inventory inv, String itemType) throws JSONException, RemoteException {
        ...
        do {
            ...
            Bundle ownedItems = mIInAppBillingService.getPurchases(
                    3,
    ...
    int querySkuDetails(String itemType, Inventory inv, List<String> moreSkus)
        ...
        for (ArrayList<String> skuPartList : packs) {
            ...
            Bundle skuDetails = mIInAppBillingService.getSkuDetails(3, mContext.getPackageName(),
                    itemType, querySkus);
    ...
    void logError(String msg) {
        Log.e(LOG_TAG, "In-app billing error: " + msg);
    }

    void logWarn(String msg) {
        Log.w(LOG_TAG, "In-app billing warning: " + msg);
    }
